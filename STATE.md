...
- Continue the accepted [continuation plan](docs/migration/continuation-plan.md): applicant completion receipts, remaining recruitment/finance outcomes and semester workflows. A new coordinator admission-decision workflow and a co-interviewer designation workflow remain separate product choices.
