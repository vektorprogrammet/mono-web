...
| Substitutes scope (interview)            | Record absences and who covered each lesson date; coordination stays in Slack. Remove the offer and dispatch flow.                                                                                                                                                                                                                                      | M               |
...
| Certificates and surveys (interview)     | On hold. The 2024 backup shows 6 certificate requests in total and no survey answers after 2022-12-05. Resume only when Evaluering or Styret asks.                                                                                                                                                                                                      | —               |
