...
# apps/backend/src/schools

This folder holds the Schools bounded context in `apps/backend/src`.
...
- [apps/dashboard/app/foldkit/schools](../../../dashboard/app/foldkit/schools/AGENTS.md)
