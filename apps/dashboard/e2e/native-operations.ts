 ...
 * native HTTP contract or an email-password route of the identity engine. Every other request,
 * such as a legacy API call or a provider, recovery, or token route, leaves it.
 *
