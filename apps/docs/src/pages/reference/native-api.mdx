...
description: Generated reference for the 53 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **53 public native operations** from the canonical OpenAPI document.
