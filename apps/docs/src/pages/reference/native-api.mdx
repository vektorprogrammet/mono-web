...
description: Generated reference for the 68 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **68 public native operations** from the canonical OpenAPI document.
