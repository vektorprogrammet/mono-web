...
description: Generated reference for the 54 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **54 public native operations** from the canonical OpenAPI document.
