...
description: Generated reference for the 73 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **73 public native operations** from the canonical OpenAPI document.
