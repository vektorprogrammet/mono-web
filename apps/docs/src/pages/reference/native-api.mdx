...
description: Generated reference for the 60 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **60 public native operations** from the canonical OpenAPI document.
