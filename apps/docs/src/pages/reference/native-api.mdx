...
description: Generated reference for the 69 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **69 public native operations** from the canonical OpenAPI document.
