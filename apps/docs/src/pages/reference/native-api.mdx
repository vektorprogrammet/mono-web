...
description: Generated reference for the 74 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **74 public native operations** from the canonical OpenAPI document.
