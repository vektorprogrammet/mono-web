...
description: Generated reference for the 75 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **75 public native operations** from the canonical OpenAPI document.
