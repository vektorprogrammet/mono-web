...
description: Generated reference for the 65 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **65 public native operations** from the canonical OpenAPI document.
