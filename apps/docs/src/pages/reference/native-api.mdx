...
description: Generated reference for the 72 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **72 public native operations** from the canonical OpenAPI document.
