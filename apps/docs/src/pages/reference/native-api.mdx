...
description: Generated reference for the 70 public operations in the native Vektorprogrammet HTTP API.
showAskAi: false
---
...
This reference contains **70 public native operations** from the canonical OpenAPI document.
