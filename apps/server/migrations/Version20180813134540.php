...
class Version20180813134540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assistant_history DROP FOREIGN KEY FK_8E3E940DA76ED395');
        $this->addSql('ALTER TABLE assistant_history ADD CONSTRAINT FK_8E3E940DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE executive_board_membership DROP FOREIGN KEY FK_1B0352A4A76ED395');
        $this->addSql('ALTER TABLE executive_board_membership ADD CONSTRAINT FK_1B0352A4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE certificate_request DROP FOREIGN KEY FK_F6CA1907A76ED395');
        $this->addSql('ALTER TABLE certificate_request ADD CONSTRAINT FK_F6CA1907A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assistant_history DROP FOREIGN KEY FK_8E3E940DA76ED395');
        $this->addSql('ALTER TABLE assistant_history ADD CONSTRAINT FK_8E3E940DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE certificate_request DROP FOREIGN KEY FK_F6CA1907A76ED395');
        $this->addSql('ALTER TABLE certificate_request ADD CONSTRAINT FK_F6CA1907A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE executive_board_membership DROP FOREIGN KEY FK_1B0352A4A76ED395');
        $this->addSql('ALTER TABLE executive_board_membership ADD CONSTRAINT FK_1B0352A4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE interview DROP FOREIGN KEY FK_CF1D3C347906D9E8');
        $this->addSql('ALTER TABLE interview DROP FOREIGN KEY FK_CF1D3C348F5D2CA9');
        $this->addSql('ALTER TABLE interview DROP FOREIGN KEY FK_CF1D3C34A76ED395');
