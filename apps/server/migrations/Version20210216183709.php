 ...
 */
final class Version20210216183709 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE todo_completed (id INT AUTO_INCREMENT NOT NULL, semester_id INT DEFAULT NULL, department_id INT DEFAULT NULL, completedAt DATE NOT NULL, todoItem_id INT DEFAULT NULL, INDEX IDX_776DEA7E4A798B6F (semester_id), INDEX IDX_776DEA7E4D6A1963 (todoItem_id), INDEX IDX_776DEA7EAE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE todo_deadline (id INT AUTO_INCREMENT NOT NULL, semester_id INT DEFAULT NULL, deadDate DATE NOT NULL, todoItem_id INT DEFAULT NULL, INDEX IDX_90903C924A798B6F (semester_id), INDEX IDX_90903C924D6A1963 (todoItem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE todo_item (id INT AUTO_INCREMENT NOT NULL, department_id INT DEFAULT NULL, semester_id INT DEFAULT NULL, createdAt DATE NOT NULL, deletedAt DATE DEFAULT NULL, priority INT NOT NULL, title VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, description VARCHAR(5000) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_40CA43014A798B6F (semester_id), INDEX IDX_40CA4301AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE todo_mandatory (id INT AUTO_INCREMENT NOT NULL, semester_id INT DEFAULT NULL, isMandatory TINYINT(1) NOT NULL, todoItem_id INT DEFAULT NULL, INDEX IDX_6549295B4A798B6F (semester_id), INDEX IDX_6549295B4D6A1963 (todoItem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
