...
class LoadSocialEventData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $socialEvent1->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent1->setSemester($this->getReference('semester-3', Semester::class));
        ...
        $socialEvent2->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent2->setSemester($this->getReference('semester-current', Semester::class));
        ...
        $socialEvent3->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent3->setSemester($this->getReference('semester-current', Semester::class));
        ...
        $socialEvent4->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent4->setSemester($this->getReference('semester-current', Semester::class));
        ...
        $socialEvent5->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent5->setSemester($this->getReference('semester-current', Semester::class));
        ...
        $socialEvent6->setDepartment($this->getReference('dep-1', Department::class));
        $socialEvent6->setSemester($this->getReference('semester-current', Semester::class));
