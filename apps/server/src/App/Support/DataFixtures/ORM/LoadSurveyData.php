...
class LoadSurveyData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $anonymousSchoolSurvey = new Survey();
        $anonymousSchoolSurvey->setSemester($semester);
        $anonymousSchoolSurvey->setDepartment($department);
        $anonymousSchoolSurvey->setName('Anonymous School Survey');
        $anonymousSchoolSurvey->setConfidential(false);
        $anonymousSchoolSurvey->setTargetAudience(Survey::$SCHOOL_SURVEY);
        $anonymousSchoolSurvey->addSurveyQuestion($surveyQuestion4);
        ...
        $this->addReference('anonymous-school-survey-1', $anonymousSchoolSurvey);
        ...
        $manager->persist($anonymousSchoolSurvey);
        $manager->flush();
    }
