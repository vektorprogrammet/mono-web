  ...
  "requests": [
    {
      ...
      "body": { "kind": "object", "keys": ["id", "firstName", "lastName", "email", "phone", "department", "fieldOfStudy", "profilePhoto"] }
    },
    {
      "method": "GET",
...
- accepted `design-specs/0003-effect-v4-receipt-sdk-compatibility.md` and the complete `packages/sdk/**` source, package, generated output, tests, and `openapi.json`;
