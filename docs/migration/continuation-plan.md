...
Social-event creation, 2026-09-21: [0110](../../design-specs/0110-native-social-event-creation.md) restores the scoped operator journey at runtime revision `9c59cb29f4766be5bf9b9e2fcc6235b415e63f9c`. Active team members create and reload events only for departments from current Organization membership; active global administrators retain all-department scope. The implementation preserves title, description, optional link, times, semester and audience without adding edit, attendance, invitation or notification behavior. The [acceptance manifest](../../evidence/functional-parity/0110/acceptance-manifest.json) records real Chromium, generated-SDK, native-API and PostgreSQL evidence for replay, conflicts, expiry, contention, revocation, immutable provenance, exact time-label boundaries, responsive rendering and cleanup.
