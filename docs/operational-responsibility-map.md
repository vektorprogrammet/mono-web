...
| Volunteer               | Maintain own profile, availability, preferences, claims, and absences with cover | Own active affiliation                         | Team or administrative authority          |
...
| Substitute coverage       | Volunteer and coordinator           | Placements and Admissions    | Slack, outside the system                         |
...
| Dated service and coverage          | A school commitment names its service interval, demand, and scheduled assistants. Absence and cover are registered. Completion, cancellation, or unfulfilled service has distinct evidence; Covered or Uncovered describes each absence only. | An absent assistant counted as having attended, an uncovered absence counted as a failed whole session, or a terminal result without its evidence. |
...
| Open service and delivery work                            | Reconcile commitments, assignments, absences, coverage records, outcomes, and pending effects at the fence. Never infer attendance or replay historical notifications.   |
