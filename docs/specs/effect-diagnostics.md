...
| E2 | `effectNative` rules in `apps/backend` | 450 on `282da16f` | In progress: 239 left after the delivery transport and the small sites (branch `refactor/effect-diagnostics-e2c-0926`); see Remaining steps |
