...
# packages/database/src/admission-period

This folder holds Admissions code under another name. Admission period persistence.
...
- [packages/database/src/admissions](../admissions/AGENTS.md)
...
| Import                                        | Module               |
| --------------------------------------------- | -------------------- |
| `@vektorprogrammet/database/admission-period` | [index.ts](index.ts) |
