...
export const databaseMigrationDefinitions = [
  ...
  {
    id: "56_legacy-backup-credential-cohort",
  ...
  {
    id: "62_recruitment-maintenance",
    name: "recruitment-maintenance",
    url: new URL("../migrations/0062-recruitment-maintenance.sql", import.meta.url),
  },
  {
    id: "63_requested-interview-rebooking",
  ...
  {
    id: "65_person-cohort-accepted-mappings",
    name: "person-cohort-accepted-mappings",
    url: new URL("../migrations/0065-person-cohort-accepted-mappings.sql", import.meta.url),
  },
  {
    id: "66_reviewed-organization-cohort",
  ...
  {
    id: "74_application-availability",
