...
# packages/database/src/placements

This folder holds the Placements bounded context in `packages/database/src`.
...
| Import                                  | Module               |
| --------------------------------------- | -------------------- |
| `@vektorprogrammet/database/placements` | [index.ts](index.ts) |
