      ...
      rows[0] === undefined
        ...
        : decode(
            Schema.Struct({
              ...
              explanatoryPower: Schema.Int,
              roleModel: Schema.Int,
              suitability: Schema.Int,
    ...
    Effect.flatMap((rows) =>
      Effect.forEach(rows, (row) =>
        decode(
          Schema.Struct({
            interviewId: Schema.String,
            predecessorRevision: Schema.Int,
            resultingRevision: Schema.Int,
            answers: Schema.Unknown,
            explanatoryPower: Schema.Int,
            roleModel: Schema.Int,
            suitability: Schema.Int,
