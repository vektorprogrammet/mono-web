...
# packages/database/src/schools

This folder holds the Schools bounded context in `packages/database/src`.
...
| Import                               | Module               |
| ------------------------------------ | -------------------- |
| `@vektorprogrammet/database/schools` | [index.ts](index.ts) |
