...
# packages/database/src/social-events

This folder holds the SocialEvents bounded context in `packages/database/src`.
...
- [packages/domain/src/social-events](../../../domain/src/social-events/AGENTS.md)
...
| Import                                     | Module               |
| ------------------------------------------ | -------------------- |
| `@vektorprogrammet/database/social-events` | [index.ts](index.ts) |
