...
# packages/domain/src/admission-period

This folder holds Admissions code under another name. Admission periods, apart from applications.
...
- [packages/domain/src/application](../application/AGENTS.md)
...
| Import                                      | Module               |
| ------------------------------------------- | -------------------- |
| `@vektorprogrammet/domain/admission-period` | [index.ts](index.ts) |
