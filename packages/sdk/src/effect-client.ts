...
/**
 * Failure channel of one generated operation: the endpoint's declared problems
 * plus the client's transport and response-decoding errors.
 */
export type EffectSdkFailure<
  Group extends keyof EffectSdk,
  Operation extends keyof EffectSdk[Group],
> = EffectSdk[Group][Operation] extends (
  ...args: never
