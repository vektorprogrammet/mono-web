...
export const seedRecruitment = async (pool) => {
  await pool.query(`
    ...
    INSERT INTO organization_memberships(membership_id,person_id,team_id,deleted_team_name,start_at,end_at,position_id,is_team_leader,is_suspended,revision) VALUES
      ('recruitment-leader','recruitment-leader','recruitment-team',NULL,date_trunc('milliseconds',now(),'UTC')-interval '24 hours',NULL,'teamleader',true,false,0),
      ('recruitment-wrong','recruitment-wrong','recruitment-wrong-team',NULL,date_trunc('milliseconds',now(),'UTC')-interval '24 hours',NULL,'teamleader',true,false,0);
