...
# Runs INSIDE the tools/preview-host dev-shell; bootstrap.sh must have run once.
set -euo pipefail
...
export PASSWORD_RESET_DELIVERY_MODE=disabled
export RECEIPT_DELIVERY_MODE=disabled
