...
try {
  postgres = await startDisposablePostgres({ database: "current_assignment_rehearsal" });
  ...
  const restoredUrl = await postgres.createDatabase("current_assignment_restored");
